...
function transform(html){
  ...
  html=html.replace(/<section class="section upcoming-section" id="maclar">[\s\S]*?<\/section>/, '<section class="section upcoming-section" id="maclar"><div class="section-head"><div><h2><span class="red-line"></span> Maçlar ve Fikstür</h2><p class="section-subtitle">17–20 Eylül 2026 · Türkiye ve Avrupa</p></div></div><div class="fixture-board"></div></section>');
